    ...
    <>
      <div className="bg-site min-h-screen px-4">
        ...
        <div className="m-auto max-w-3xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 pb-8 px-4" id="projet">
          ...
          <OriginalCard text={<> <span className="font-bold">Profitz</span> - Profitz est une plateforme d'analyse financière pour optimiser les investissements. <a href="https://app.profitz.fr/" className="text-teal-600" >Voir le projet</a></>} />
